<template>
    <div
        class="max-w-md rounded shadow-md m-4 text-jost text-sm text-gray-300 bg-gray-900"
    >
        ...
        <div
            class="w-full text-sm rounded text-lobster text-gray-700 flex flex-wrap content-start ml-1 pb-1 mt-2"
        >
            <div

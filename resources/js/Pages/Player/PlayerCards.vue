...
<h1 class="text-jost font-semibold text-xl tracking-wide bg-amber-200 text-gray-700">My cards</h1>
        ...
        <div v-for="userCard in state.userCards" :key="userCard.id" class="">
            ...
            <div
                v-if="                   
                    userCard.status == 'exchange'
                "
                class="py-0.5 border-1 border-gray-800 w-24 md:w-36"
            >
                <img
            ...
            <div
                ...
                class="bg-gray-100 py-0.5 border-1 border-gray-800 w-24 md:w-36"
            >
                <img
                    @click="changeStatusUserCard(userCard, 'exchange')"

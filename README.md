...
installation
composer create-project laravel/laravel cards (copy installation in "cards" folder) composer require laravel/breeze php artisan breeze:install vue npm install npm run dev
